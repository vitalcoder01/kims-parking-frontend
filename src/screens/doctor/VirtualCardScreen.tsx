...
const s = StyleSheet.create({
  safe: {flex: 1},
  center: {flex: 1, padding: 24, alignItems: 'center'},
  heading: {fontSize: 22, fontWeight: '900', marginBottom: 6},
  sub: {fontSize: 13, textAlign: 'center', marginBottom: 32, lineHeight: 18},

  card: {width: '100%', borderRadius: 24, padding: 24, marginBottom: 24, overflow: 'hidden', shadowColor: '#2563EB', shadowOffset: {width: 0, height: 12}, shadowOpacity: 0.4, shadowRadius: 20, elevation: 16},
